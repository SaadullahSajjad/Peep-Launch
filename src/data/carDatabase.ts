export const carDatabase: Record<string, string[]> = {
  Acura: ['CSX','ILX', 'Integra', 'MDX', 'RDX', 'RLX', 'TLX', 'ZDX', 'NSX'],
  ...
  Chevrolet: ['Aveo','Blazer', 'Bolt EV', 'Bolt EUV', 'Camaro', 'Colorado', 'Corvette', 'Equinox', 'Express', 'Malibu','Orlando','Optra', 'Silverado 1500', 'Silverado 2500', 'Silverado 3500', 'Suburban', 'Tahoe', 'Trailblazer', 'Traverse', 'Trax'],
  ...
  Nissan: ['Altima', 'Ariya', 'Armada', 'Frontier', 'GT-R', 'Kicks', 'Leaf', 'Maxima', 'Murano', 'Pathfinder', 'Rogue', 'Sentra', 'Titan', 'Versa', 'Z','Micra','X-Trail'],
  Polestar: ['2', '3'],
  Pontiac:['Wave'],
